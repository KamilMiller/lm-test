...
/* harmony import */ var _modules_user_list_render__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/user-list-render */ "./js/modules/user-list-render.js");
/* harmony import */ var _modules_users_sort__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/users-sort */ "./js/modules/users-sort.js");
/* harmony import */ var _modules_users_search__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/users-search */ "./js/modules/users-search.js");
/* harmony import */ var _modules_delete_user_item__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/delete-user-item */ "./js/modules/delete-user-item.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_delete_user_item__WEBPACK_IMPORTED_MODULE_7__["initDeleteUsers"])();

  // Modules
  // ---------------------------------
  Object(_modules_user_list_render__WEBPACK_IMPORTED_MODULE_4__["initUserListRender"])();
  Object(_modules_users_sort__WEBPACK_IMPORTED_MODULE_5__["initSort"])();
  Object(_modules_users_search__WEBPACK_IMPORTED_MODULE_6__["initUsersSearch"])();
...
var DATA_REQUEST_URL = 'https://5ebbb8e5f2cfeb001697d05c.mockapi.io/users';

// Получение данных с сервера
var getData = function getData() {
  return fetch(DATA_REQUEST_URL).then(function (response) {
    if (response.ok) {
      return response.json();
    }
    throw new Error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0434\u0430\u043D\u043D\u044B\u0435 \u0441 \u0441\u0435\u0440\u0432\u0435\u0440\u0430 :( \u041A\u043E\u0434 \u043E\u0448\u0438\u0431\u043A\u0438: ".concat(response.status_code));
  }).then(function (json) {
    return json;
  }).then(function (data) {
    return data;
...
/***/ "./js/modules/delete-user-item.js":
/*!****************************************!*\
  !*** ./js/modules/delete-user-item.js ***!
  \****************************************/
/*! exports provided: getUserID, initDeleteUsers */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getUserID", function() { return getUserID; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initDeleteUsers", function() { return initDeleteUsers; });
var confirmButton = document.querySelector('.modal-confirm__button--yes');
var userItemID;
var getUserID = function getUserID(evt, buttonClass) {
  var target = evt.target.closest(buttonClass);
  userItemID = target.dataset.id;
};
var deleteUserAfterConfirm = function deleteUserAfterConfirm() {
  var userItems = document.querySelectorAll('.data__item');
...
var initDeleteUsers = function initDeleteUsers() {
...
/***/ "./js/modules/user-list-render.js":
/*!****************************************!*\
  !*** ./js/modules/user-list-render.js ***!
  \****************************************/
/*! exports provided: userListRender, initUserListRender, userDataArr */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "userListRender", function() { return userListRender; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initUserListRender", function() { return initUserListRender; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "userDataArr", function() { return userDataArr; });
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api */ "./js/modules/api.js");
/* harmony import */ var _delete_user_item__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./delete-user-item */ "./js/modules/delete-user-item.js");


var userItemTemplate = document.querySelector('#user').content.querySelector('.data__item');
var userDataList = document.querySelector('.data__list');
var openModalHiddenButton = document.querySelector('.data__open-modal');
var userDataArr = [];

// Сборка строки с датой регистрации
var getSixDigitDate = function getSixDigitDate(fullData) {
  var dataString = String(fullData);
  var sixDigitDate = "".concat(dataString[8]).concat(dataString[9], ".").concat(dataString[5]).concat(dataString[6], ".").concat(dataString[0]).concat(dataString[1]).concat(dataString[2]).concat(dataString[3]);
  return sixDigitDate;
};

// Сборка элемента списка с данными пользователя
var buildUserItem = function buildUserItem(fragment, element) {
  var userItem = userItemTemplate.cloneNode(true);
  ...
  userItem.querySelector('.data__delete-button').addEventListener('click', function (evt) {
    Object(_delete_user_item__WEBPACK_IMPORTED_MODULE_1__["getUserID"])(evt, '.data__delete-button');
...
var userListRender = function userListRender(data) {
  userDataArr = data;
  var fragment = document.createDocumentFragment();
  userDataArr.forEach(function (item) {
    buildUserItem(fragment, item);
  });
  document.querySelectorAll('.data__item').forEach(function (element) {
    return element.remove();
  });
  userDataList.appendChild(fragment);
  return userDataArr;
};
var initUserListRender = function initUserListRender() {
  var dataPromise = Object(_api__WEBPACK_IMPORTED_MODULE_0__["getData"])();
...
/***/ "./js/modules/users-search.js":
/*!************************************!*\
  !*** ./js/modules/users-search.js ***!
  \************************************/
/*! exports provided: initUsersSearch */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initUsersSearch", function() { return initUsersSearch; });
var searchInput = document.getElementById('user-email');
var searchInputClearButton = document.querySelector('.search-form__submit');
var onInputSearch = function onInputSearch() {
  var text = searchInput.value.toLowerCase().trim();
  var usersItems = document.querySelectorAll('.data__item');
  if (text !== '') {
    usersItems.forEach(function (elem) {
      var userName = elem.querySelector('.data__item-name');
      var userEmail = elem.querySelector('.data__item-email');
...
var initUsersSearch = function initUsersSearch() {
...
/* harmony import */ var _user_list_render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user-list-render */ "./js/modules/user-list-render.js");


var sortButtons = document.querySelectorAll('.data__control-button');
var ratingSortButton = document.querySelector('[data-sort-rating]');
var registrationDataSortButton = document.querySelector('[data-sort-registration]');
var userDataCopy = [];
var ascendingSort = {
  'registrationData': true,
  'rating': true
};
var sortByRating = function sortByRating(arr) {
...
var sortByRegistrationData = function sortByRegistrationData(arr) {
  var temp = JSON.parse(JSON.stringify(arr));
...
var initSort = function initSort() {
  ratingSortButton.addEventListener('click', function () {
    sortByRating(_user_list_render__WEBPACK_IMPORTED_MODULE_0__["userDataArr"]);
    Object(_user_list_render__WEBPACK_IMPORTED_MODULE_0__["userListRender"])(userDataCopy);
    sortButtons.forEach(function (button) {
      return button.classList.remove('data__control-button--active');
    });
    ratingSortButton.classList.add('data__control-button--active');
  });
  registrationDataSortButton.addEventListener('click', function () {
    sortByRegistrationData(_user_list_render__WEBPACK_IMPORTED_MODULE_0__["userDataArr"]);
    Object(_user_list_render__WEBPACK_IMPORTED_MODULE_0__["userListRender"])(userDataCopy);
    sortButtons.forEach(function (button) {
      return button.classList.remove('data__control-button--active');
    });
